...
> 🎓 Estudante de **Análise e Desenvolvimento de Sistemas** em transição para **Produto Digital**
> Com background em Neurociências, Marketing e +6 anos criando conteúdo para +300k pessoas
...
background:  ["Neurociências", "Marketing Digital", "Criação de Conteúdo"]
estudando:   ["Python", "Git", "Metodologias Ágeis", "User Research"]
buscando:    "Estágio em Produto em fintechs ou grandes empresas de tech"
```
...
![Lean Six Sigma](https://img.shields.io/badge/Lean%20Six%20Sigma-009900?style=for-the-badge)
...
|---|---|---|
| 📱 **MVP App Educacional** | App para desenvolvimento de funções executivas em adolescentes — UNIFESP (Mestrado em Inovação Tecnológica) | Figma · UX Research · Neurociências |
| 📊 **Surpreendente +300k** | Criação e gestão completa de página de curiosidades multiplataforma com crescimento 100% orgânico | Estratégia · Analytics · Produção |
...
![Visitor Count](https://komarev.com/ghpvc/?username=SEU_USERNAME&color=6E40C9&style=flat-square&label=Visitantes+do+perfil)

*"Entender pessoas é a melhor habilidade que um profissional de tecnologia pode ter."*
